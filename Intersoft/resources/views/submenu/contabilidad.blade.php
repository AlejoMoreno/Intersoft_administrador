                    ...
                    <table class="table table-hover table-striped"  id="datos">
                                    ...
                                    <tbody>
                                        <tr onclick="config.Redirect('/contabilidad/cuentas');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/154/154923.svg"></td>
                                            <td>PUC</td>
                                            <td></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/comprobantesdiario');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/2145/2145545.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/librosauxiliares');">
                                            <td><img width="30" src="https://www.flaticon.es/premium-icon/icons/svg/2090/2090647.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/librosmayores');">
                                            <td><img width="30" src="https://www.flaticon.es/premium-icon/icons/svg/2144/2144086.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/balancecomprobacion');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/950/950943.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/perdidasganancias');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/943/943800.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/analisismensual');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/1006/1006636.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/mediosmagneticos');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/888/888850.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/balancegeneral');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/2145/2145673.svg"></td>
                                        ...
                                        <tr onclick="config.Redirect('/contabilidad/certificados');">
                                            <td><img width="30" src="https://image.flaticon.com/icons/svg/2132/2132241.svg"></td>
                                            <td>Certificados</td>
                                            <td></td>
                                            <td><img width="20" src="https://image.flaticon.com/icons/svg/265/265727.svg">
                                            </td>
