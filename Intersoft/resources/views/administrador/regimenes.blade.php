...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="header">
                    <h4 class="title">Regimenes</h4>
                    <p class="category">Diferentes regimenes de Colombia</p>
                </div>
                <div class="content">
                        ...
                        <tbody>
                            @foreach ($regimenes as $regimen)
                                <tr>
                                    ...
                                    <td><a href="/administrador/regimenes/update/{{  $regimen['id'] }}"><button class="btn btn-warning">></button></a></td>
                                    <td><a href="/administrador/regimenes/delete/{{  $regimen['id'] }}"><button class="btn btn-danger">x</button></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    <h4>Crear Regimenes</h4>
                    <table class="table table-hover table-striped" id="tableregimenes">
                        <thead>
                            <tr>
                                <th>Nombre</th> 
                        ...
                        <tbody>
                            <tr>
                                <form action='/administrador/regimenes/create' method="POST">
