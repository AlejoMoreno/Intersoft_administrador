                        ...
                        <tbody>
                            @foreach ($retefuentes as $retefuente)
                                <tr>
                                    ...
                                    <td><a href="/administrador/retefuentes/update/{{  $retefuente['id'] }}"><button class="btn btn-warning">></button></a></td>
                                    <td><a href="/administrador/retefuentes/delete/{{  $retefuente['id'] }}"><button class="btn btn-danger">x</button></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
