...
<div class="enc-article">
  <h4 class="title">Cierres de inventario</h4>
</div>
...
<div class="row top-11-w">
  ...
  <div class="col-md-7" style="overflow-x:scroll;margin-left:2%">
    <h2 class="title">Generar cierre de inventario</h2>
    <form method="POST" action="/inventario/cierreInventario" class="row" style="margin:2%;">
