        ...
        <div class="col-sm-12">
          <div class="card"> 
            <div class="row">
              ...
              <div class="col-sm-2">
                <label>Número de documento: </label><input type="number" name="numero" id="numero" class="form-control" value="">
              </div>
              <div class="col-sm-6"><br>
                <?php echo '<a style="color:red;margin-left: 30%;" href="/cartera/egresos"> + Generar Nuevo Documento</a>'; ?>
              </div>
            </div>
            ...
            <div>
              <div class="col-sm-12">
                <div class="row titulo">
                  ...
                  <div class="col-sm-12" style="height: 20px;"></div>
                  <div class="col-sm-12">
                    <div id="Guardar" class="btn btn-success form-control" onclick="carteras.save_documento();" style="background-color: #28a745;color:white;">GUARDAR</div>
