...
<div class="enc-article">
  <h4 class="title">Cierres contable</h4>
</div>
...
<div class="row top-11-w">
  ...
  <div class="col-md-7" style="overflow-x:scroll;margin-left:2%">
    <h2 class="title">Generar cierre contable</h2>
    <form method="POST" action="/contabilidad/cierrecontable" class="row" style="margin:2%;">
